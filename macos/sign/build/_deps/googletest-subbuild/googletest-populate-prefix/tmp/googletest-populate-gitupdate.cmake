...
execute_process(
  COMMAND "/usr/bin/git" show-ref "03597a01ee50ed33e9dfd640b249b4be3799d395"
  WORKING_DIRECTORY "/Users/siddhuchelluru/Documents/GitHub/ColorSign/macos/sign/build/_deps/googletest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/siddhuchelluru/Documents/GitHub/ColorSign/macos/sign/build/_deps/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/siddhuchelluru/Documents/GitHub/ColorSign/macos/sign/build/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
